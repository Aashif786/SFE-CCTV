...
# Kills any orphan process holding port 8000 before starting the server.
...
Write-Host "Starting CALVISION backend on port 8000..." -ForegroundColor Green
& "$PSScriptRoot\venv\Scripts\python.exe" -m uvicorn src.main:app --host 0.0.0.0 --port 8000
