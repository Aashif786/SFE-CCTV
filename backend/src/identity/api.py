...
def _event_to_dict(e: IdentityEvent) -> dict:
    return {
        ...
        "device_event_time": getattr(e, "device_event_time", None) or e.timestamp.isoformat(),
        "received_at": e.received_at.isoformat() if getattr(e, "received_at", None) else None,
        "time_offset_seconds": getattr(e, "time_offset_seconds", None),
        "auth_type": getattr(e, "auth_type", None) or "Card/Face Verification",
        "card_no": getattr(e, "card_no", None),
        "access_granted": getattr(e, "access_granted", True),
